...
var finalMessages = {
    "correct10": "CONGRATULATIONS!<br>You answered all the questions correctly. You've saved astronaut Dave.",
    "correct9": "GREAT JOB!<br>You answered 90% of the questions correctly. Just enough to save astronaut Dave with a tether.",
    "correct8": "NICE GOING!<br>You answered 80% of the questions correctly. We're still able to retrieve astronaut Dave with a tether.",
    "correct7": "You answered 70% of the questions correctly. Not enough to retrieve astronaut Dave but still in range for the International Space Station to possibly pick him up.",
    "correct6": "You answered 60% of the questions correctly. Not enough to retrieve astronaut Dave but possibly still in range for the International Space Station to possibly pick him up.",
    "correct5": "You answered 50% of the questions correctly. Hal 9000 outsmarted you and got rid of astronaut Dave but we may still have options.",
    "correct4": "You answered 40% of the questions correctly. Astronaut Dave was counting on you but Hal 9000 gained too much control.",
    "correct3": "You answered 30% of the questions correctly. You weren't trying to get rid of astronaut Dave were you?",
    "correct2": "You answered 20% of the questions correctly. How was the Hal 9000 able to gain access to your password to overtake the system?",
    "correct1": "You did poorly only answering 1 correctly. Astronaut Dave will someday reenter Earth's atmosphere as space junk burning up on descent.",
    "correct0": "WHAT HAPPENED?<br>You didn't get any correct and doomed astronaut Dave. The Hal 9000 has enough control to send you out with Dave soon."
};
...
function nextWord() {
    // check to see if questions are over and "FINAL RESULTS" button clicked
...
$("#letterBtns").children().on("click", function() {      
    clearInterval(countDown); // clear countdown timer on letter click
...
function correct() {  
    ...
    if (questionCounter < 10) {       
        ...
        $("#nextWord").show(); // display NEXT WORD button
        $("#nextWord").children().eq(0).html("FINAL RESULTS");
    }        
}

// execute on incorrect answer
function incorrect() {
    // show correct answer and clear answer choices
...
// clears and prepares for next word
...
// display final msg and prepare for game restart
function finalResults() {
        $("#nextWord").hide(); // hide NEXT WORD button
        $("#nextWord").children().eq(0).html("NEXT QUESTION");
        ...
        // send tether to rescue Dave if only 2 or less wrong
        if (failures < 3 && failures > 0) {
            $("#tether").show();
            $("#tether").animate({ width: "600px" });
            setTimeout(function() {
                $("#tether").animate({ width: "50px" }, 2000);
    ...
    setTimeout(function() {
        ...
        $("#odyssey")[0].play(); // play 2001 Space Odyssey full audio
    }, 2000);
}
